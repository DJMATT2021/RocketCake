...
wsp_slideshow.prototype.calculateFade = function(now)
{
	...
	else
	{
		...
		this.setAlpha(currentImageAlpha, currentPage, true);
		this.setAlpha(lastImageAlpha, lastShownPage, true);	
	}
...
wsp_slideshow.prototype.setAlpha = function(alpha, img, alsoUpdateDisplayBasedOnOpacity)
{
	if (img)
	{
		...
		if (alsoUpdateDisplayBasedOnOpacity)
		{
			if (alpha < 0.1)
